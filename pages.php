...
overflow:hidden; height:600px; width:1000px;" allowTransparency="true"></iframe>'
    ...
    <?php if ($user): ?>
      <img width="100" height ="100" style="position:absolute;left:1000px;right:200px;" src="https://graph.facebook.com/<?php echo $user; ?>/picture">
...
//$multiQuery = '{ "query1": select uid2 from friend where uid1=me()",
 ...
 $multiQuery = '{ "query1": "select uid2 FROM friend WHERE uid1=me()",
 "query2":"select uid from page_fan WHERE uid in (SELECT uid2 FROM friend WHERE uid1=me()) AND page_id=131163930317669"}';
